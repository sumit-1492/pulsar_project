...
## Model prediction related variable

MODEL_PREDICTION_ARTIFACT_DIR_NAME = "PREDICTED_MODEL_RESULT"
MODEL_PREDICTION_BATCH_DIR_NAME = f"BATCH_DATA_{CURRENT_DATE_TIME_STAMP}"
BATCH_CSV_FILE_NAME = f"BATCH_DATA_{CURRENT_DATE_TIME_STAMP}.csv"
MODEL_PREDICTION_INSTANCE_DIR_NAME = f"INSTANCE_DATA_{CURRENT_DATE_TIME_STAMP}"
INSTANCE_CSV_FILE_NAME = f"INSTANCE_DATA_{CURRENT_DATE_TIME_STAMP}.csv"